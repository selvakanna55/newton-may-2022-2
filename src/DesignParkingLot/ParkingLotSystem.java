...
public class ParkingLotSystem {
    public static void main(String[] args) {
        ...
        floorMapping.put(VehicleType.CAR, new Floor(100, 1));
        ...
        floorMapping.get(VehicleType.CAR).display();
...
class EntryGate extends Gate {
    ...
    Ticket issueTicket(Vehicle v, HashMap<VehicleType, Floor> floorMapping) {
        ...
        if (!currentFloor.canIPark()) {
            System.out.println("Parking is full");
            return null;
        }
        Ticket t1 = new Ticket(ticketNo, floorMapping.get(v.vehicleType), "10:30");
        ticketNo++;
        return t1;
    }
}
